...
class TestSearchFunctionality:
    ...
    def test_search_all_match(self):
        ...
        results = self.client._search_submissions_dict(
            self.test_submissions, "neural time", match_mode="all"
        )
    ...
    def test_search_exact_match(self):
        ...
        results = self.client._search_submissions_dict(
            self.test_submissions, "time series", match_mode="exact"
        )
    ...
    def test_search_no_results(self):
        ...
        results = self.client._search_submissions_dict(
            self.test_submissions, "quantum computing", match_mode="any"
        )
